...
export default class CorporationStrategy {
  ...
  toJson (): any {
    return {
      ...
      policy: this.policy,
      otherTycoonId: this.otherTycoonId,
      otherTycoonName: this.otherTycoonName,
      otherCorporationId: this.otherCorporationId,
      otherCorporationName: this.otherCorporationName,
